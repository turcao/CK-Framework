...
/* harmony import */ var _views_char_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./views/char-select */ "./src/scripts/views/char-select.js");
...
var Main = function Main() {
  ...
  new _views_char_select__WEBPACK_IMPORTED_MODULE_0__["default"]();
};
...
/***/ "./src/scripts/views/char-select.js":
/*!******************************************!*\
  !*** ./src/scripts/views/char-select.js ***!
  \******************************************/
  ...
  _createClass(CharSelect, [{
    ...
    value: function initScript() {
      window.vm = new vue_dist_vue_common__WEBPACK_IMPORTED_MODULE_0___default.a({
        ...
        methods: {
          deleteChar: function deleteChar(charid) {
            $.post("http://ck_selector/DeleteCharacter", JSON.stringify({
              charid: charid
            }));
          },
          selectChar: function selectChar(charid) {
            $.post("http://ck_selector/SelectCharacter", JSON.stringify({
              charid: charid
            }));
          },
          emitCharacters: function emitCharacters(listcharacters) {
            this.characters = null;
            this.showCharList = true;
            this.characters = listcharacters;
          },
          clearCharacters: function clearCharacters() {
...
/* harmony default export */ __webpack_exports__["default"] = (CharSelect);
